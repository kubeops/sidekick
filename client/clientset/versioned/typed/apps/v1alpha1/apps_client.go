...
import (
	...
	"kubeops.dev/sidekick/client/clientset/versioned/scheme"
...
// AppsV1alpha1Client is used to interact with features provided by the apps.k8s.appscode.com group.
type AppsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AppsV1alpha1Client) Sidekicks(namespace string) SidekickInterface {
	return newSidekicks(c, namespace)
}
